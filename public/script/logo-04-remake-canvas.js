...
const SEED = 51149,
  ...
  uS = (e, t, r, a, l) => {
    ...
    let s = V2();
    (CANV = "black"), (WALL = "lightgrey"), (SHDW = "black");
    FPS = 30;
    let d = ((e, t) => {
        V2();
        let r = V2();
      ...
      h = (e, t, r) => {
        if (!e.skip) {
          let t = pow(Mapf(V(e), 0, 600, 1, 0), 6),
            a = 0.5 * max(0.001, 4 * t * f(e.t)),
            l = (d(e), e.x),
            C = e.y;
    ...
    let D = ((e, t, r) => {
        ...
        let n = i(g, H),
          s = i(l, b);
        return (
          (C[0] = o(30, H, S, T, v(-3, 8, y, r, 450, g))),
          (C[1] = o(30, b, S, T, v(3, 8, y, r, 450, l))),
          CVR(),
          () => (
            CVS(),
            t(),
            ...
            FoE(C, (e) => e()),
            CVR(),
            !(H.length || b.length || g.length || l.length)
          )
        );
      })(
        SEED,
