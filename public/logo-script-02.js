...
const SEED = 77345,
  ...
  uS = (e, t, r, C, n) => {
    ...
    let F = (
      ...
      A = ctx.createRadialGradient(0, 0, 0, 0, 0, 600);
    A.addColorStop(0, cM(0, 1)),
      A.addColorStop(0.2, cM(0, 1)),
      A.addColorStop(0.35, cM(0, 0.1)),
      A.addColorStop(0.5, cM(0, 0)),
      A.addColorStop(1, cM(0, 0));
    let x,
      H,
      y,
      V,
    ...
    let G = [],
      I = ((t, r, C, n = []) => {
        ...
        l.A.push([1, 1]),
          ...
          l.A.push([PX - 1, PX - 1]),
          l.A.push([PX, 1]),
          For(0, 5, (t) => l.A.push([HX + e.i(-100, o), HX + e.i(-100, o)]));
        let i = (r, C) => {
            let n = 1 / 0.85,
        ...
        return () => {
          ...
          do {
            ...
            t &&
              (s.get(t[0], t[1]) ||
                (s.set(t[0], t[1], 1), i(t[0], t[1]), n.push(t))),
              e++;
