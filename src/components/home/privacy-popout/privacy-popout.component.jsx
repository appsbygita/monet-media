import {
  ...
  PopupContent,
  CloseButton,
} from "./privacy-popout.styles";
import CloseIcon from "../../../assets/close.svg";

export const PrivacyPopout = ({ onPrivacyClick, className }) => {
  return (
    <DisplayContainer className={className}>
      <TopRow>
        <CloseButton src={CloseIcon} onClick={onPrivacyClick} />
      </TopRow>
      <PopupContent>
        <h2>Privacy Policy</h2>
        <p>
          https://monetmedia.ai/ website is owned by Monet Media, which is a
          data controller of your personal data.
        </p>
        <p>
          We have adopted this Privacy Policy, which determines how we are
          processing the information collected by https://monetmedia.ai/, which
        ...
        <p>
          When you visit the https://monetmedia.ai/, we automatically collect
