import {
  ...
  PopupContent,
  CloseButton,
} from "./terms-popout.styles";
import CloseIcon from "../../../assets/close.svg";

export const TermsPopout = ({ onTermsClick, className }) => {
  return (
    <DisplayContainer className={className}>
      <TopRow>
        <CloseButton src={CloseIcon} onClick={onTermsClick} />
      </TopRow>
      <PopupContent>
        <h2>Terms and Conditions</h2>
        <p>Welcome to Monet Media!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Monet Media's Website, located at https://monetmedia.ai/.
        </p>
        <p>
          By accessing this website, we assume you accept these terms and
          conditions. Do not continue to use Monet Media if you do not agree to
          take all of the terms and conditions stated on this page.
        </p>
        <h4>Cookies:</h4>
        <p>
          The website uses cookies to help personalize your online experience.
          By accessing Monet Media, you agreed to use the required cookies.
        </p>
        <p>
        ...
        <h4>License:</h4>
        <p>
          Unless otherwise stated, Monet Media and/or its licensors own the
          intellectual property rights for all material on Monet Media. All
          intellectual property rights are reserved. You may access this from
          Monet Media for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Copy or republish material from Monet Media</li>
          <li>Sell, rent, or sub-license material from Monet Media</li>
          <li>Reproduce, duplicate or copy material from Monet Media</li>
          <li>Redistribute content from Monet Media</li>
        </ul>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>
          Parts of this website offer users an opportunity to post and exchange
          opinions and information in certain areas of the website. Monet Media
          ...
          opinions of Monet Media, its agents, and/or affiliates. Comments
          reflect the views and opinions of the person who posts their views and
          opinions. To the extent permitted by applicable laws, Monet Media
          shall not be liable for the Comments or any liability, damages, or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          Monet Media reserves the right to monitor all Comments and remove any
        ...
        <p>
          You hereby grant Monet Media a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Monet Media; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to Monet Media. Please include your name, your
        ...
        <p>
          No use of Monet Media's logo or other artwork will be allowed for
